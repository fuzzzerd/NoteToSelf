...
sourceUrl: "https://stackoverflow.com/q/4035036"
---

*I [asked this on Stack Overflow](https://stackoverflow.com/q/4035036):*
...
> [Nate answered](https://stackoverflow.com/a/4088593) (0 upvotes):
>
...
**Nate** (0 upvotes): Either -- if I have to use WebRequest then authorizing would be my issue, because I can't just send credentials can I? If there is a more clevor way, like adding a reference to my mvc-app, then rendering would be the issue. Long story short, I'm not sure where to begin.

</details>

---
*Originally posted on [Stack Overflow](https://stackoverflow.com/q/4035036) — 2 upvotes. Licensed under [CC BY-SA](https://creativecommons.org/licenses/by-sa/4.0/).*
