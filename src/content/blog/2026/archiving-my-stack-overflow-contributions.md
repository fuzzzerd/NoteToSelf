...
Accepted answers become blog posts, questions with a score of 10+ become blog posts, and everything else goes to a private archive folder. The script works with any Stack Exchange site — just pass the site key and your user ID.
